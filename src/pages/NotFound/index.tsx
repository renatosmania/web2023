  ...
  return (
    <div className="flex h-screen w-full items-center justify-center bg-ignite-gray-1">
      <div className="flex flex-col text-center leading-relaxed text-ignite-primary-light">
        ...
        <span className="text-black">Página não encontrada!</span>
        <Link
          to={"/"}
          title="Voltar para a página inicial."
          className="bg-black px-4 py-3 mt-4 flex justify-center text-white hover:bg-gray-400 transition-all duration-300 dark:bg-gray-600 dark:hover:bg-gray-400"
        >
          Voltar
        </Link>
      </div>
