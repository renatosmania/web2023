...
export function Projects() {
  return (
    <section className="w-full flex justify-center">
      <div className="md:w-[968px] lg:w-[1024px]  mx-7 lg:mx-0">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-3 md:gap-3 px-7 md:px-0">
          <li className="overflow-hidden relative md:h-[330px] group">
            <a href="#">
              <img
