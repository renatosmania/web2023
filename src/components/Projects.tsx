    ...
    <section className="w-full flex justify-center my-7">
      <div className="md:w-[968px] lg:w-[1024px] flex flex-col mx-7 lg:mx-0">
        ...
        <Swiper
          ...
          className="px-7 py-6 md:px-0 max-w-sm md:max-w-[768px] lg:max-w-[1024px]"
        >
          ...
          <div className="swiper-button-next  bottom-5 md:bottom-0 top-[initial] after:text-sm right-[initial] left-20 md:left-12 p-2 text-sm bg-black w-[initial] h-[initial] text-white">
            <CaretRight size={24} />
          </div>
          </div>
        </Swiper>
